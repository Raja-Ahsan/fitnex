				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" autocomplete="off" class="form-control" name="google_calendar_id" id="google_calendar_id" value="{{ old('google_calendar_id', $trainer->google_calendar_id) }}" placeholder="Enter Google Calendar ID or paste full URL (e.g., https://calendar.app.google/vqjFXvdZs3cUJxry8)">
