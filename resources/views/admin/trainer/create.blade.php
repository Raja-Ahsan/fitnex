					...
					<div class="box-body"> 
							...
							<div class="col-sm-9">
								<select name="trainer_types[]" class="form-control" multiple="multiple" required>
									@foreach($categories as $category)
										<option value="{{ $category->slug }}" {{ in_array($category->slug, old('trainer_types', [])) ? 'selected' : '' }}>{{ $category->title }}</option>
									@endforeach
								</select>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								...
								<label class="checkbox-inline"><input type="checkbox" name="delivery_online" value="1" {{ old('delivery_online', '1') === '1' ? 'checked' : '' }}> Online</label>
								<label class="checkbox-inline" style="margin-left:15px;"><input type="checkbox" name="delivery_in_person" value="1" {{ old('delivery_in_person', '1') === '1' ? 'checked' : '' }}> In-person</label>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" autocomplete="off" class="form-control" name="gym_name" value="{{ old('gym_name') }}" placeholder="e.g. Equinox Downtown, LA Fitness">
