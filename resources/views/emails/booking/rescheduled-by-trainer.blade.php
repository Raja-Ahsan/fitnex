...
<body>
    <div class="container">
        <div class="header">
            <h1>Booking Rescheduled by Trainer</h1>
        </div>

        <div class="content">
            <p>Hi {{ $customer->name }},</p>

            <p>Your trainer has rescheduled your booking.</p>
            ...
            <p>If this new time doesn't work for you, please contact your trainer or reschedule the session.</p>
        </div>
