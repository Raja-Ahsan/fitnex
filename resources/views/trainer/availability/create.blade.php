                        ...
                        <form action="{{ route('trainer.availability.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="session_duration" id="session_duration"
                                    ...
                                    <option value="30" {{ old('session_duration') == '30' ? 'selected' : '' }}>30 minutes
                                    </option>
                                    <option value="45" {{ old('session_duration') == '45' ? 'selected' : '' }}>45 minutes
                                    </option>
                                    <option value="60" {{ old('session_duration') == '60' ? 'selected' : '' }}>60 minutes
                                    </option>
                                </select>
                                ...
                                <small class="form-text text-muted">
                                    Time slots will be automatically generated based on this duration.
                                </small>
                            </div>
