        ...
        <div class="container">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div>
                    ...
                    @endif
                    <form action="{{ route('appointments.store') }}" id="regform" class="form-horizontal"
                        ...
                        @guest
                            <div class="mb-4">
                                ...
                                <input type="text" id="name" name="name" class="w-full bg-gray-800 border-gray-600 rounded p-3"
                        ...
                        <div class="custom-appointment-scheduler mb-6">
                            <div
                                class="scheduler-header rounded-t-xl p-5 flex items-center justify-between shadow-lg relative">
                                <div class="flex items-center space-x-4 relative z-10">
                                    <div
                                        class="bg-opacity-25 backdrop-blur-md rounded-xl p-3 shadow-lg border border-white border-opacity-30">
                                        <i class="fas fa-calendar-alt  text-2xl"></i>
                                    </div>
                                    <div>
                                        <h3 class="text-white font-bold text-xl mb-1 drop-shadow-lg">Select Your Appointment
                                            Time</h3>
                                        <p class="text-blue-100 text-sm flex items-center font-medium"
                                            id="current-timezone-display">
                                ...
                                <div
                                    class="bg-opacity-25 backdrop-blur-md text-white px-5 py-3 rounded-full border border-white border-opacity-40 shadow-lg relative z-10 hover:bg-opacity-30 transition-all duration-300">
                            ...
                            <div
                                class="scheduler-body bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-b-xl p-6 shadow-2xl">
                                <!-- Date Selection -->
                                <div class="mb-6">
                                    ...
                                    <div
                                        class="custom-calendar bg-gray-800 rounded-xl p-6 border border-gray-700 shadow-xl">
                                        <div class="calendar-header flex items-center justify-between mb-6">
                                            <button type="button" id="prev-month"
                                                class="text-white hover:text-blue-400 transition-all p-3 rounded-xl hover:bg-gray-700 hover:scale-110">
                                                <i class="fas fa-chevron-left text-lg"></i>
                                            </button>
                                            <h5 class="text-white font-bold text-xl" id="current-month-year">November 2025
                                            </h5>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="time-slots grid grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3"
                                        id="time-slots">
                                ...
                                <div id="selected-appointment"
                                    class="bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl p-4 border-2 border-blue-400 shadow-lg"
                                    style="display: none;">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-blue-100 font-bold text-lg" id="selected-appointment-text">No
                                                    appointment selected</p>
                                            </div>
                                        </div>
                                        <button type="button" id="clear-selection"
                                            class="text-white hover:text-red-300 transition-colors p-2 rounded-lg hover:bg-white hover:bg-opacity-20">
                        ...
                        <div class="mb-6">
                            <label for="description" class="block text-lg font-medium mb-2">Additional Notes
                                (Optional)</label>
                            <textarea id="description" name="description" rows="4"
                                class="w-full bg-gray-800 border-gray-600 rounded p-3 text-white"
