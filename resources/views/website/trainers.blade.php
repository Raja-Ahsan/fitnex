            ...
            <div class="">
                <div class="grid grid-cols-1 lg:grid-cols-4 gap-x-8 gap-y-16 justify-items-center max-w-5xl mx-auto">
                    ...
                    @foreach ($trainers as $trainer)
                        <div class="trainer-card flex" data-title="{{ $trainer->trainer_type }}"
                            data-description="{{ $trainer->description }}" data-price="Price: ${{ $trainer->price }}"
                            data-aos="flip-right" data-aos-easing="linear" data-aos-duration="1500">
                                ...
                                <div class="relative overflow-hidden rounded-lg h-[450px] w-[300px] flex-shrink-0">
                                    ...
                                    <div class="absolute top-5 left-5 flex flex-col space-y-2 social-media-links">
                                        <a href="{{ $trainer->twitter }}"
                                            class="bg-white text-black w-8 h-8 rounded-md flex justify-center items-center no-underline transition-all duration-300 expoert-traning-card hover:text-white hover:scale-110"><i
